...
public class SettingUserForTest {
    ...
    protected void settingProject() {
        CompanyProjectRequestDTO req1 = new CompanyProjectRequestDTO(
                "네이버",
                "이수진",
        ...
        CompanyProjectRequestDTO req2 = new CompanyProjectRequestDTO(
                "코카콜라",
                "정민영",
                "kdhyun422@gmail.com",
        ...
        Project project1 = Project.createRecruitingProject(
                companyRepository.findByEmail("navernaver@gmail.com").get(),
                req1
        );

        Project project2 = Project.createRecruitingProject(
                companyRepository.findByEmail("kdhyun422@gmail.com").get(),
                req2
        );
