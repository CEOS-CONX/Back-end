...
public class PromotionalMessageConsent extends BaseEntity {
    private PromotionalMessageConsent(User user, boolean isAllowed){
    ...
    public static PromotionalMessageConsent create (User user, boolean isAllowed){
        return new PromotionalMessageConsent(user, isAllowed);
    }
}
