...
public enum NotificationType {
    ...
    QUESTION_REGISTERED("%s에 담당자 Q&A가 등록되었습니다."), //담당자 Q&A 등록, 프로젝트 이름

    //크루용 알림
    PROJECT_SELECTED("%s에 선정되었습니다."), //프로젝트에 선정됨. 프로젝트 이름
    PROJECT_REJECTED("%s에 선정되지 못했습니다."), //프로젝트에 선정되지 않음. 프로젝트 이름
    QUESTION_ANSWER_REGISTERED("%s에 작성한 담당자 Q&A에 답변이 등록되었습니다."), //프로젝트에 담당자 Q&A에 답변이 등록됨. 프로젝트 이름

    CLOSE_TO_END_OF_MARKED_PROJECT("북마크한 %s 프로젝트가 %d일 뒤 마감됩니다."), //북마크한 프로젝트 마감기한 임박. 프로젝트 이름과 마감까지 남은 날짜

    ADJUSTMENT_DONE("%s에 정산이 완료되었습니다."), //정산 완료. 프로젝트 이름
