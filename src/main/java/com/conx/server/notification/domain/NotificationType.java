...
public enum NotificationType {
    ...
    QUESTION_REGISTERED("%s 프로젝트에 담당자 Q&A가 등록되었습니다."), //담당자 Q&A 등록, 프로젝트 이름

    //크루용 알림
    PROJECT_SELECTED("%s 프로젝트에 선정되었습니다."), //프로젝트에 선정됨. 프로젝트 이름
    PROJECT_REJECTED("%s 프로젝트에 선정되지 못했습니다."), //프로젝트에 선정되지 않음. 프로젝트 이름
    QUESTION_ANSWER_REGISTERED("%s 프로젝트에 작성한 담당자 Q&A에 답변이 등록되었습니다."), //프로젝트에 담당자 Q&A에 답변이 등록됨. 프로젝트 이름
